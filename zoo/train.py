...
from stable_baselines3.common.env_util import make_vec_env ##NY 
...
from gym.envs.registration import register ## NY
from MultiSwapEnviorment import swap_enviorment ## NY
...
register(
    ...
    kwargs = {"depth_of_code": depth_of_code, "rows": rows, "cols": cols, "max_swaps_per_time_step": max_swaps_per_time_step}
)
...
if __name__ == "__main__":  # noqa: C901
    ...
    parser.add_argument("--env", type=str, default="MultiSwapEnviorment-v0", help="environment ID")
